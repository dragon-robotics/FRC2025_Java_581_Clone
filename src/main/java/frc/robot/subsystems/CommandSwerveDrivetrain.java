...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
  ...
  /**
   * The MapleSim SwerveDrivetrain used for simulation. This is null if the robot is not in
   * simulation. It is used to update the simulated drivetrain state.
   */
  ...
  public void periodic() {
    ...
    /* Log the current state of the drivetrain */
